    ...
    <script>
        ...
        $(function () {
            ...
            $("#writeBtn").click(function () {
                ...
                let payPd_seq = $("#payPd_seq").val();
                let id = $("#id").val();
                let content = $("#content").val();
                let star = $(".star option:selected").val();
...
<form action="/pdReview/insertReview" method="post" id="frm">
    ...
    <div class="cart__mainbtns btns">
        <button class="cart__bigorderbtn left" type="button" id="writeBtn">리뷰 작성</button>
        <button class="cart__bigorderbtn right" type="button" id="cancleBtn">취소</button>
    </div>
</form>
</body>
</html>