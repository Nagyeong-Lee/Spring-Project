...
<div class="popup">
  <form action="" method="post">
    ...
    <div class="pdInfo">
      ...
      <div>사유 : <textarea id="content" name="content">${refundPdInfo.CONTENT}</textarea></div>
    </div>
<%--    <div class="deliInfo">--%>
<%--      <h5>배송지 선택</h5>--%>
...
<%--      </c:choose>--%>
<%--    </div>--%>
    <button type="button" id="cancleRefundBtn" class="btn btn-light">교환 취소</button>
...
<script>
  ...
  //환불 취소 클릭 시
  $("#cancleRefundBtn").click(function () {
    if(confirm('교환을 취소하시겠습니까?')){
      $.ajax({
        url: '/product/cancleExchange',
        type: 'post',
        data: {
